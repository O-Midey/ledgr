...
const features = [
  ...
  },
  {
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        <path
          d="M8 2L13 5V9C13 11.8 10.8 14.4 8 15C5.2 14.4 3 11.8 3 9V5L8 2Z"
          stroke="currentColor"
          strokeWidth="1.1"
          strokeLinejoin="round"
        />
  ...
  },
  {
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        />
        <path
          d="M5 5V4C5 2.9 5.9 2 7 2H9C10.1 2 11 2.9 11 4V5"
          stroke="currentColor"
          strokeWidth="1.1"
        />
      ...
      <div className="landing-container">
        ...
        <div className="features-grid">
          {features.map((f) => (
            <article
              key={f.title}
              className={`feature-card scroll-reveal ${f.featured ? "feature-card-featured" : ""} ${f.wide ? "feature-card-wide" : ""} ${f.tall ? "feature-card-tall" : ""}`}
            >
